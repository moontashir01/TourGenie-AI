...
export default function CommandPalette() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-start justify-center pt-[12vh] px-4 print:hidden">
      ...
      <div
        ...
        className="relative w-full max-w-lg card shadow-lift overflow-hidden animate-pop-in"
      >
        <div className="flex items-center gap-3 px-4 border-b border-sand">
          ...
          />
          <kbd className="hidden sm:block text-[10px] font-mono text-ink-900/35 border border-sand rounded px-1.5 py-0.5">
            esc
          </kbd>
        </div>
          ...
          {results.length === 0 ? (
            ...
            results.map((cmd, i) => {
              ...
              return (
                <div key={cmd.id}>
                  {showGroup && (
                    <p className="px-4 pt-2.5 pb-1 text-[10px] font-bold uppercase tracking-wider text-ink-900/30">
                      {cmd.group}
                    </p>
                  )}
                  <button
                  ...
                  >
                    ...
                    <span className="min-w-0 flex-1">
                      ...
                      {cmd.hint && <span className="block text-[11px] text-ink-900/45 truncate">{cmd.hint}</span>}
                    </span>
        ...
        <footer className="flex items-center gap-4 px-4 py-2 border-t border-sand bg-paper/60 text-[10px] text-ink-900/40">
